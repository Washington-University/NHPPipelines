			...
			if [[ $(echo -n ${Modalities} | grep "C") ]] ; then
				...
				case ${MatlabRunMode} in
					...
					1)
						...
						hcppath="${HCPPIPEDIR}/global/matlab"
						giftipath="${HCPPIPEDIR}/global/matlab/gifti-1.6"	
						matlab -nojvm -nodisplay -nosplash <<M_PROG
addpath '$mPath'; addpath '$hcppath'; addpath '$giftipath'; MSMregression('${inputspatialmaps}','${inputdtseries}','${inputweights}','${outputspatialmaps}','${outputweights}','${Caret7_Command}','${Method}','${Params}','${VN}',${nTPsForSpectra},'${BC}','${VolParams}');
M_PROG
						log_Msg "addpath '$mPath'; addpath '$hcppath'; addpath '$giftipath'; MSMregression('${inputspatialmaps}','${inputdtseries}','${inputweights}','${outputspatialmaps}','${outputweights}','${Caret7_Command}','${Method}','${Params}','${VN}',${nTPsForSpectra},'${BC}','${VolParams}');"
						;;
