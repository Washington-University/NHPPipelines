...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/glibc-2.14/lib:/usr/local/cuda-6.5/lib64  # valid for compass-s in RIKEN
...
if [ "$2" == "" ];then
    ...
    echo " Run PreTractograhy_RIKEN.sh before running this script"
    echo ""
    exit 1
fi
